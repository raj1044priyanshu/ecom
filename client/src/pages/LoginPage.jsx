  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 section-cream">
      ...
      <div className="max-w-md w-full space-y-8 card p-8 sm:p-10 shadow-2xl border-2 border-surface-300 rounded-[2rem] bg-white relative overflow-hidden">
        ...
        <div className="absolute -top-10 -right-10 w-32 h-32 bg-primary-100 rounded-full blur-2xl opacity-50 z-0"></div>
        ...
        <div className="relative z-10">
          ...
          <p className="mt-3 text-center text-sm font-bold text-gray-700">
            Or{' '}
            <Link to="/register" className="text-primary-600 hover:text-primary-700 transition-colors uppercase tracking-wide">
        ...
        <form className="mt-8 space-y-6 relative z-10" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center group cursor-pointer">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-5 w-5 text-primary-600 focus:ring-primary-500 border-2 border-surface-300 rounded-md cursor-pointer transition-all"
              />
              <label htmlFor="remember-me" className="ml-3 block text-sm font-bold text-gray-800 cursor-pointer group-hover:text-gray-900 transition-colors">
                Remember me
              </label>
            </div>

            <div className="text-sm">
              <Link to="/forgot-password" className="font-black text-primary-600 hover:text-primary-700 transition-colors">
                Forgot password?
              </Link>
            </div>
          </div>
          ...
          <div className="pt-4 border-t-2 border-surface-300 mt-6">
            ...
            >
              {submitting ? <Spinner className="h-6 w-6 text-white" /> : 'Log in'}
            </button>
          </div>
        </form>
